...
class AnswerService:
    ...
    async def update_answer(self, db: AsyncSession, answer_id: int, update_dto: AnswerUpdateRequest) -> dict[str, int]:
        """
        ...
        반환값:
        - dict[str, int]: 수정된 answer의 개수가 포함된 성공 응답을 반환합니다.
        """
        async with db.begin():
    ...
    async def delete_answer(self, db: AsyncSession, answer_id: int) -> dict[str, int]:
        """
        ...
        반환값:
        - dict[str, int]: 삭제된 answer의 개수가 포함된 성공 응답을 반환합니다.
        """
        async with db.begin():
